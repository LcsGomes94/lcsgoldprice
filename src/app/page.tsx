...
export default function Home() {
  ...
  function calculatePrice(goldPrice: number) {
    ...
    if (usd) {
      finalPrice =
        goldPrice * salesTax * withdrawTax * conversionTax * 1000 * usd;
    }
  ...
  return (
    ...
    >
      <div className={`flex flex-col items-center`}>
        <h1
          className={`text-xl bg-gradient-to-tr bg-clip-text text-transparent from-red-600 via-red-200 to-white`}
        >
          USD Price
        </h1>
      ...
      <div
        className={`bg-gradient-to-tr from-teal-500 to-cyan-500 rounded-xl p-0.5`}
      >
        <div
          className={`flex gap-7 text-2xl items-center rounded-xl px-7 py-4 bg-slate-800`}
        >
          <h1 className={`text-xl w-24 text-center`}>Gold Price</h1>
          <div
            className={`h-10 w-0.5 bg-gradient-to-b from-teal-500 to-cyan-500`}
          ></div>
          <input
            autoFocus={true}
            type="number"
      ...
      <div className={`flex flex-col items-center`}>
        <h1
          className={`text-xl bg-gradient-to-tr bg-clip-text text-transparent from-green-700 to-yellow-400`}
        >
          R$/K
        </h1>
